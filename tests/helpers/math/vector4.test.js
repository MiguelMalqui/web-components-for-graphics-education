...
import Vector4 from "../../../src/helpers/math/vector4.js";
...
describe("Vector4", () => {
    ...
    describe("elements", () => {
        it("should return the coordinates as an array", () => {
            const v = new Vector4(x, y, z, w);
            expect(v.elements).toEqual([x, y, z, w]);
        });
    });
    ...
    describe("mulMatrix", () => {
        it("should multiply by a matrix", () => {
            ...
            const m1 = (new Matrix4x4()).translate(x, y, z);
            const result = v1.mulMatrix(m1);
    ...
    describe("normalize", () => {
        it("should normalize the vector in place", () => {
            ...
            expect(v.z).toBeCloseTo(expected.z, numDigits);
            expect(v.w).toBeCloseTo(expected.w, numDigits);
        });
    });
    ...
    describe("normalized", () => {
        it("should normalize the vector and return a new one", () => {
            ...
            expect(u.z).toBeCloseTo(expected.z, numDigits);
            expect(u.w).toBeCloseTo(expected.w, numDigits);
            expect(v.x).toBe(x);
            expect(v.y).toBe(y);
            expect(v.z).toBe(z);
            expect(v.w).toBe(w);
