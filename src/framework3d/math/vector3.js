...
export default class Vector3 {
    ...
    /**
     * Returns a new Vector3, result of add v to this vector
     * @param {Vector3} v 
     * @returns {Vector3}
     */
    add(v) {
    ...
    /**
     * Returns a new Vector3, result of add the scalar value s to this vector's 
     * x, y and z values
     * @param {number} s 
     * @returns {Vector3}
     */
    ...
    /**
     * Returns a new Vector3, result of subtract v from this vector
     * @param {Vector} v 
     * @returns {Vector3}
     */
    sub(v) {
    ...
    /**
     * Returns a new Vector3, result of subtract the scalar value s from this
    ...
    /**
     * Returns a new Vector3, result of multiply this vector by scalar s
     * @param {number} s 
     * @returns {Vector3}
     */
    mulScalar(s) {
    ...
    /**
     * Returns a new Vector3, result of divide this vector by scalar s
     * @param {number} s 
     * @returns {Vector3}
     */
    divScalar(s) {
    ...
    /**
     * Returns a new Vector3, result of the cross product of this vector and v
     * @param {Vector3} v 
     * @returns 
     */
    cross(v) {
    ...
    /**
     * Returns a new Vector3, result of normalize this vector
     * @returns
     */
    normalize() {
